...
<!-- AUTONOMOUS_START -->
<!-- DATA_FIRST_START -->
- **Stage 9 (data-first final claim repair):** the orchestrator explicitly routes you here with only one exact `output/polish_identification_final_c{C}.md` report. This is not a triage-file invocation: jump to **"Data-first final claim repair"** near the end of this body and apply its binding workflow.
<!-- DATA_FIRST_END -->
<!-- AUTONOMOUS_END -->
<!-- MANUAL_START -->
