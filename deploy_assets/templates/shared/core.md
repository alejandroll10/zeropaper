...
<!-- DATA_FIRST_START -->
| `spec_audit_revision` † | 3 | current dataset architecture's Gate-2 spec mutations | fresh theory identity / sketch-swap escalation — `docs/stage_2.md` |
