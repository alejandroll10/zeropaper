...
RUNTIME_ENV_KEYS = {
    ...
    "BUNDLE_SSL_CA_CERT", "OPENAI_API_KEY", "UF_API_KEY", "DEEPINFRA_TOKEN",
...
SECRET_ENV_KEYS = {
    "OPENAI_API_KEY", "UF_API_KEY", "DEEPINFRA_TOKEN", "LOCAL_LLM_API_KEY",
}
NETWORK_ENV_KEYS = {
    "HTTP_PROXY", "HTTPS_PROXY", "ALL_PROXY", "NO_PROXY",
    "http_proxy", "https_proxy", "all_proxy", "no_proxy",
    "BUNDLE_HTTP_PROXY", "BUNDLE_HTTPS_PROXY", "BUNDLE_NO_PROXY",
    "OPENAI_API_KEY", "UF_API_KEY", "DEEPINFRA_TOKEN",
    "LOCAL_LLM_API_KEY", "LOCAL_LLM_BASE_URL", "LOCAL_LLM_MODEL",
}
