...
Like Rule 7, this is mechanical: it does not judge whether the concern is *correct*, only whether the referee did the reading the concern's weight requires (issue #95 — the Charles–Frydman–Kılıç "Insensitive Investors" false-competitor case: a real DOI, but a lab experiment, not a demand-system competitor).
