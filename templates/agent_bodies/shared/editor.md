...
- **You cannot recommend what the paper does next** (extension playbook vs. deepen vs. regenerate vs. ship narrow). That is branch-manager's job. You produce the verdict; branch-manager takes it from there at gate-5-reject if Reject fires.
