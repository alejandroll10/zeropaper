...
4. **An OpenAlex/journal abstract or an SSRN page does not satisfy the marker** — SSRN is not fetchable and an abstract is not full text. A `[fulltext:…]` URL pointing at an SSRN abstract page or a bare DOI/abstract is treated as missing for this rule.
