...
| 3 | polish-prose | critical | add | §1 introduction | Intro establishes neither economic stakes nor a literature anchor | Add a stakes sentence on why the magnitude matters; anchor against gennaioli2015neglected (in references.md) | (`Disp. = add` per rule 5 pass-through — additive, not a cut) |
| ... |
