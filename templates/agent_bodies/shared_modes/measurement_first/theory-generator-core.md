...
- **This is the audited artifact.** Both math audits (structured and free-form) run on this output, and Gate 4's H3 requires them to pass. Write derivations completely enough to audit — the "posit, don't derive" rule of construct mode does not apply here; this is precisely where the deriving happens.{{THEORY_EXTRA_RULES}}
