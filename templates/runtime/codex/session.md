...
- **How you dispatch agents depends on which runtime you are.** This `AGENTS.md` is read by two runtimes (Codex and Grok Build); follow the branch that matches the CLI you are running, and ignore the other.
